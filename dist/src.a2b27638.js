...
function eventHandler() {
  ...
  if (status > 0) {
    result.innerText = "You have a loss of " + Math.abs(status) + " ruppees and the loss percentage is " + Math.abs(status / totalinvestment * 100);
  } else if (status == 0) {
    result.innerText = "You have no profit or loss";
  } else if (status < 0) {
    result.innerText = "You have a profit of " + Math.abs(status) + " ruppees and the profit percentage is " + Math.abs(status / totalinvestment * 100);
  }
}
